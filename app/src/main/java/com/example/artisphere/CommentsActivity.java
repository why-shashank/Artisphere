...
import com.example.artisphere.Adapter.CommentAdapter;
import com.example.artisphere.Model.Comment;
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (add_comment.getText().toString().equals("")){
                    Toast.makeText(CommentsActivity.this,"Comment is empty",Toast.LENGTH_SHORT).show();
    ...
    private void getImage(){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(getApplicationContext()).load(user.getDp()).into(image_profile);
